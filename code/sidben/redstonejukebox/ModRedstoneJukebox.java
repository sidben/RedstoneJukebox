...
public class ModRedstoneJukebox {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        ModRedstoneJukebox.redstoneJukebox = new BlockRedstoneJukebox(ModRedstoneJukebox.redstoneJukeboxIdleID, false).setHardness(2.0F).setResistance(10.0F).setUnlocalizedName("sidbenRedstoneJukebox").setStepSound(Block.soundStoneFootstep).setCreativeTab(CreativeTabs.tabRedstone).func_111022_d("redstone_jukebox_off");
