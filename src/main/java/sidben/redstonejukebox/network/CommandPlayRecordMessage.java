...
/**
 * Parameters from the /playrecord and /playrecordat commands.
 *  
 */
public class CommandPlayRecordMessage implements IMessage
{
    ...
    public CommandPlayRecordMessage(int recordInfoId, boolean showName, double x, double y, double z, int range) {
    ...
    public void playRecord() {
        ...
        if (world != null) {
            ModRedstoneJukebox.instance.getMusicHelper().playRecordAt(world, (int)this.x, (int)this.y, (int)this.z, this.recordInfoId, this.showName, this.range);
        }
    }
